...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  Widget build(BuildContext context) {
    int total = 26500 * widget.ticket.seats.length; //dikali jumlah tiket
                  ...
                  Stack(
                    children: <Widget>[
                      ...
                      BlocBuilder<UserBloc, UserState>(
                        //blockbuilder itu untuk penggil user
                        builder: (_, userState) {
                                    ...
                                    Text(
                                      ...
                                      style: whiteNumberFont.copyWith(
                                          color: user.balance >= total
                                              ? Color(0xFF3E9D9D) //hijau
                                              : Color(0xFFFF5C83), //merah
                                          fontSize: 16,
                                          fontWeight: FontWeight.w600),
                                    )
                                  ],
