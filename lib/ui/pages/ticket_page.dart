    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
              ...
              builder: (_, ticketState) => Container(
                    ...
                    child: TicketViewer(isExpiredTickets
                        ? ticketState.tickets
                            ...
                            .toList() //ini kuncinya waktu kemarin
                        : ticketState.tickets
                            .where((ticket) =>
                                !ticket.time.isBefore(DateTime.now()))
                            .toList()),
          ...
          // note: HEADER
          Container(
            //ini untuk statusbar biar warnanya ungu
            height: 113,
            color: accentColor1,
          ),
          SafeArea(
                            ...
                            child: Text(
                              ...
                              style: whiteTextFont.copyWith(
                                  ...
                                  color: !isExpiredTickets
                                      ? Colors
                                          .white //false=bukan yg expired brarti putih
                                      : Color(0xFF6F678E)), //yang expierd
                            ),
                          ),
                          SizedBox(
                            height: 15,
...
class HeaderClipper extends CustomClipper<Path> {
  //clipper buat bikin tab atas round
  @override
...
class TicketViewer extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var sortedTickets = tickets; //tiket yang diurutkan
    sortedTickets
        ...
        itemBuilder: (_, index) => GestureDetector(
              ...
              child: Container(
                margin: EdgeInsets.only(
                    top: index == 0
                        ? 133
                        : 20), //kalo paling atas dikasih 133(dibawah header) atau 20 di antara tiket
                child: Row(
                  children: <Widget>[
                    Container(
                      width: 70,
                    ...
                    SizedBox(
                        //kasih lebar ke judulnya gar ga tembus ke samping
                        width: MediaQuery.of(context)
                                .size
                                .width - //lebarlayar-defmarg-poster-margin ke tulisan
                            2 * defaultMargin -
                            70 -
                            16,
                        child: Column(
