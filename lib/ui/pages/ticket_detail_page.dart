    ...
    return WillPopScope(
      onWillPop: () {
        context.bloc<PageBloc>().add(GoToMainPage(
            bottomNavBarIndex: 1,
            isExpired: ticket.time.isBefore(DateTime
                .now()))); //supaya kembali kepage yg benar bukan ke main page
                        ...
                        Align(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              context.bloc<PageBloc>().add(GoToMainPage(
                                  bottomNavBarIndex: 1,
                                  isExpired: ticket.time.isBefore(
                                      DateTime.now()))); //disini juga backnya
                            },
                            child: Icon(
                              Icons.arrow_back,
                              color: Colors.black,
