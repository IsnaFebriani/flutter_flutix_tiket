                        ...
                        BlocBuilder<UserBloc, UserState>(
                          builder: (_, userState) => Column(
                            children: <Widget>[
                              ...
                              Container(
                                height: 185,
                                width: double.infinity, //menuhin space
                              ...
                              FutureBuilder(
                                  ...
                                  builder: (_, snapshot) {
                                    if (snapshot.hasData) {
                                      //return data transaksi, atau spinkit
            ...
            Align(
              ...
              child: Container(
                ...
                child: RaisedButton(
                    ...
                    onPressed: () {
                      context.bloc<PageBloc>().add(GoToTopUpPage(GoToWalletPage(
                          pageEvent))); //kalo kembali, kembali ke walletpage
                    }),
              ),
            )
          ],
